...
raw_data_path = r"C:\Users\haddo\yolov8\peces_antonio\lr_study\raw_val_data.json"
save_path = r"C:\Users\haddo\yolov8\peces_antonio\lr_study\lr_study_results.csv" # CSV extension pls
...
df = pd.DataFrame(columns=['lr', 'F1(B)', 'F1(M)', 'mAP50(B)', 'mAP50(M)', 'mAP50-95(B)', 'mAP50-95(M)'])
