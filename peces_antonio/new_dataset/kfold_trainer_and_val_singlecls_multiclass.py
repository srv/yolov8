...
if __name__ == "__main__":
    ...
    parser.add_argument("--freeze", type=int, default=False, help="Layers to freeze (default: No freeze)")
    ...
    if do_train:
        ...
        for i in range(1, 2):
            ...
            for model_size in model_sizes.keys():
                ...
                pretrained_model_path = fr"C:\Users\haddo\yolov8\peces_antonio\new_dataset\new_pipeline\kfold_large_1280_own_lr_0.01_singlecls\large\fold_{i}\weights\best.pt"
                model = YOLO(pretrained_model_path)
                
                train_dict["name"] = f"fold_{i}"
                train_dict["project"] = project_name
                train_dict["workers"] = 4
                train_dict["single_cls"] = False
